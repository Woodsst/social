...
def test_edit_post(postgres_cur: Cursor, http_session: Session, add_test_data_in_postgres: None):
    """Test - edit post."""
    ...
    assert post_data_from_db.get("post") == post_for_edit_request_body.get("content")
...
@pytest.mark.parametrize(
    "status_code, body",
    (
            (HTTPStatus.NOT_FOUND, {"content": "new content",
                                    "post_id": "3fa85f64-5717-4562-b3fc-2c963f66afa6"}),
            (HTTPStatus.UNPROCESSABLE_ENTITY, {"Wrong": "Request",
                                               "Format": True}),
